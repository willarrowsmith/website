...
const playlists: {
...
}[] = [
  {
    ...
    href: "/factset/peerpitch"
  },
  {
    id: 3,
    name: "Product Manager (Pricing Tools) & Business Analyst (Data Center & AI)",
    description: "Intel",
