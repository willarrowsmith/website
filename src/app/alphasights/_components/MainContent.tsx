...
const featuredPlaylist: {
  ...
  id: 0,
  name: "Hey AlphaSights Recruitment!",
...
const playlists: {
  ...
  },
  {
    ...
    href: "/alphasights/myexeter"
  },
  {
    id: 3,
    name: "Product Designer (Pricing Tools) and Business Analyst (Data Center & AI)",
    description: "Intel",
    imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Intel.jpg-EajCfst7cSVAnnSjbIooUdcqiHcj3y.jpeg",
    href: "/alphasights/intel"
  },
  {
    id: 4,
    name: "Coding",
