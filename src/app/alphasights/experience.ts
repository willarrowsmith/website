import type { Experience } from "@/app/alphasights/_components/ExperienceContent";
...
export const experiences: Record<string, Experience> = {
  ...
  intel: {
    title: "Product Designer (Pricing Tools) and Business Analyst (Data Center & AI)",
  ...
  <li>Collaborated with technical teams and pricing managers to implement tool enhancements, improving the accuracy and efficiency of pricing decisions and reducing pricing response time by 25%.  </li>
